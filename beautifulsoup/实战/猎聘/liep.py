...
class LiePin(object):
    ...
    def get_first_html(self, url):
        ...
        try:
            ...
            print("解析出现错误")
            self.get_first_html(url)
            
    
    def get_next_html(self, url):
        """如果查询结果存在下一页，需要重新得到html
        """
        headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:76.0) Gecko/20100101 Firefox/76.0'
        }
    ...
    def handle_one_page(self,soup):
        ...
        for each_item in job_lists:
            print('*'*100)
            self.handle_one_item(each_item)
    ...
    def start(self):
        ...
        先解析第一页，在解析后续页面
        """
        firt_html = self.get_first_html(self.url)
...
if __name__ == "__main__":
    ...
    demo = LiePin('https://www.liepin.com/zhaopin/?', '生物信息')
    demo.start()
